...
public class Activity5 extends Activity 
{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try{
			...
			httpPost = new HttpPost("http://www.**********.com/top.php/");
		...
		lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			   ...
			   public void onItemClick(AdapterView<?> parent, View view, int position, long id) 
			   {
				    ...
				    String postss = all_posts[position];				
				    String[] newpost = postss.split("> ");
		...
		b1.setOnClickListener( new View.OnClickListener()
		{
			...
			{
				Intent act4 = new Intent(Activity5.this,Activity4.class);
		...
		b3.setOnClickListener( new View.OnClickListener()
		{
			...
			public void onClick(View arg0) 
			{
				...
				Intent act5 = new Intent(Activity5.this,Activity3.class);
				act5.putExtra("data",result);
				startActivity(act5);
				finish();
		...
		sv.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                Activity5.this.arrayAdapter.getFilter().filter(cs);   
            }
